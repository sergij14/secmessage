...
},{"../es":"node_modules/core-js/es/index.js","../web":"node_modules/core-js/web/index.js","../internals/path":"node_modules/core-js/internals/path.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
if (message) {
  ...
  messageShow.insertAdjacentHTML("afterbegin", "<h2 class=\"sec-message\">".concat(message, "</h2>"));
}
...
document.querySelector("form").addEventListener("submit", function (event) {
  ...
  var encrypeted = btoa(input.value);
  var link = document.querySelector("#link-input");
  link.value = "".concat(window.location, "#").concat(encrypeted);
  link.select();
...
//# sourceMappingURL=/secMessage.e31bb0bc.js.map